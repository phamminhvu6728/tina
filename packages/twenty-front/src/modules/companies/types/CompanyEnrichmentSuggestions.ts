...
export type CompanyEnrichmentFieldName = keyof CompanyEnrichmentSuggestedFields;

export type EnrichCompanyFromDomainStatus =
  | 'MATCHED'
  | 'PARTIAL'
  | 'NOT_FOUND'
  | 'ERROR';

export type EnrichCompanyFromDomainResult = {
  domain: string;
