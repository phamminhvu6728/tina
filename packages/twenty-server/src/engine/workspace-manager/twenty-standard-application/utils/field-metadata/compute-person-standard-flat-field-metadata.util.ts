...
>): Record<AllStandardObjectFieldName<'person'>, FlatFieldMetadata> => ({
  ...
  birthday: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      fieldName: 'birthday',
      type: FieldMetadataType.DATE,
      label: i18nLabel(msg`Birthday`),
  ...
  customerType: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      ...
      options: [
        {
          id: 'b071b030-5c93-46d5-b48f-581daa32d1de',
          value: 'VIP',
          label: 'VIP',
          position: 0,
          color: 'yellow',
        ...
        {
          id: 'de594f71-6ba0-494a-8043-49b879214f7e',
          value: 'VVIP',
          label: 'VVIP',
          position: 1,
          color: 'purple',
