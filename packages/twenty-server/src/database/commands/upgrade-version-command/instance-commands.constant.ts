...
import { AddDefaultPhoneCountryCodeToWorkspaceFastInstanceCommand } from './2-25/2-25-instance-command-fast-1787220000000-add-default-phone-country-code-to-workspace';
...
export const INSTANCE_COMMANDS = [
  ...
  AddDefaultPhoneCountryCodeToWorkspaceFastInstanceCommand,
];
