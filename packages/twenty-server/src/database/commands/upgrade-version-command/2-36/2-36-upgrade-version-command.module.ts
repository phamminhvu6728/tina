...
import { RefreshTinasoftWorkflowLogicFunctionsCommand } from 'src/database/commands/upgrade-version-command/2-36/2-36-workspace-command-1790200000000-refresh-tinasoft-workflow-logic-functions.command';
import { RepairTinasoftInterviewWorkflowsCommand } from 'src/database/commands/upgrade-version-command/2-36/2-36-workspace-command-1790300000000-repair-tinasoft-interview-workflows.command';
...
@Module({
  ...
  providers: [
    ...
    RefreshTinasoftWorkflowLogicFunctionsCommand,
    RepairTinasoftInterviewWorkflowsCommand,
  ],
})
